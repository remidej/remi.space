...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    footerSections: Schema.Attribute.Component<'footer.links-section', true> &
      Schema.Attribute.Required;
    footerSocialNetworks: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    navbarSocialNetworks: Schema.Attribute.Relation<
      'oneToMany',
      'api::social-network.social-network'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    metadata: Schema.Attribute.Component<'shared.metadata', false> &
      Schema.Attribute.Required;
    nickname: Schema.Attribute.String & Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slices: Schema.Attribute.DynamicZone<
